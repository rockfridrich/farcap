...
export async function action({
  ...
  params
    ...
    // } else 
    if (buttonIndex == 1) {
        return redirect(`${process.env.DOMAIN}/buy/${coin.address}?amount=0.01`, 302);
    } else if(buttonIndex === 2) {
        return redirect(`${process.env.DOMAIN}/buy/${coin.address}?amount=0.1`, 302);
    } else if (buttonIndex == 3) {
        return redirect(`${process.env.DOMAIN}/buy/${coin.address}?amount=1`, 302);
    }
